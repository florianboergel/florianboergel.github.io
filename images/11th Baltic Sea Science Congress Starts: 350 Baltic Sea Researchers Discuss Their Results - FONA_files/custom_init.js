...
$('#rechte_seite .medien_kasten_slider .flexslider:not(.portrait_slider,.podcast_slider)').flexslider({
    ...
    nextText: "Nächstes Sliderelement",
    startAt: 0,
    touch: true,
...
// Erstellt den Flexslider mit CB-Funktionen für den Zähler
...
// Fügt HTML-Code zum Flexslider hinzu (Zähler, Minimieren/Maximieren Link)                      
...
// Click-Event für den Minimieren/Maximieren Link / Setzt auch eine spezifische Klasse und Text für den Link                      
...
// Dreht die Reihenfolge der Vor- und Zurückpfeile im DOM um: Sinnvoll, da ansonsten beim Aufklappen und Zuklappen der Thumbnail-Vorschau die Pfeile bei rel. Positionierung springen
